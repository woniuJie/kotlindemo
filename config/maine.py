...
print('xxxxx')
f = open('/users/shijiezhang/AndroidStudioProjects/kotlindemo/app/src/main/res/layout/fragment_blank_rest.xml','r')
alllines = f.readlines()
f.close()
f = open('/users/shijiezhang/AndroidStudioProjects/kotlindemo/app/src/main/res/layout/fragment_blank_rest.xml','w')
